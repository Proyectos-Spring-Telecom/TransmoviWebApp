...
export class MantenimientoCombustibleComponent {
    ...
    constructor(
      ...
      private manteVeh: MantenimientoCombustibleService,
    ...
    obtenerlistaManVehicular() {
      this.loading = true;
      this.manteVeh.obtenerManCombustible().subscribe((response: any[]) => {
        this.loading = false;
        ...
        load: async (loadOptions: any) => {
          ...
          try {
            const resp: any = await lastValueFrom(
              this.manteVeh.obtenerManCombustiblesData(page, take)
            );
            this.loading = false;
